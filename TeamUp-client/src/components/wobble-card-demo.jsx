  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
      ...
      >
        ...
        <Image
          src="https://teaching.utoronto.ca/wp-content/uploads/ow5kp_pj85q-scaled.jpg"
          width={500}
          height={500}
      ...
      <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
        ...
        <Image
          src="https://img.freepik.com/free-photo/excited-colleagues-discussing-some-questions-library_74855-1834.jpg"
          width={500}
          height={500}
          alt="linear demo image"
